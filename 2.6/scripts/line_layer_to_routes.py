...
writer = VectorWriter(routes, None, [QgsField("line_id", QVariant.Int),QgsField("length",QVariant.Double)], network_layer.dataProvider().geometryType(), network_layer.crs() )
