...
##routes_with_oneways=output vector
...
writer = VectorWriter(routes_with_oneways, None, [QgsField("line_id", QVariant.Int),QgsField("length",QVariant.Double)], network_layer.dataProvider().geometryType(), network_layer.crs() )
